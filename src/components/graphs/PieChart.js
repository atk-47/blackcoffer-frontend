...
//Made this blank template to directly load the data from backend and make a PieChart
const PieChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/sample-data'); //add the address of your data to make a piechart
